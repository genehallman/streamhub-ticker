...
describe('A TickerView', function () {
    ...
    describe('can be constructed', function() {
        ...
        it ("with an el", function () {
            ...
            expect($('#hub-TickerView')).toBeDefined();
            var view = new TickerView({
                el: $('#hub-TickerView')
            });
            expect(view).toBeDefined();
    ...
    describe ("after correct construction", function () {
        ...
        it ("should have scrolled all the way right after data was received", function () {
            ...
            runs(function() {
                ...
                expect(view.$el[0].scrollLeft).toBe(50 * 50 - 100); //bootstrap * item.width - el.width
                expect(view.$el.find('.hub-item').length).toBe(50);
            });                   
        });
        it ("should be scrollable to a piece of content", function () {
            ...
            runs(function() {
                expect(view.$el[0].scrollLeft).toBe(50 * 50 - 100); //item.id+1 * item.width - el.width);
            });
        });
        it ("should be scrollable to a piece of content", function () {
            view.$el.width(100);
            ...
            runs(function() {
                expect(view.$el[0].scrollLeft).toBe(0); // it will stop at 0
            });
        });
        it ("should be scrollable to a piece of content", function () {
            view.$el.width(100);
            ...
            runs(function() {
                expect(view.$el[0].scrollLeft).toBe(20 * 50 - 100); //item.id+1 * item.width - el.width
            });
        });
